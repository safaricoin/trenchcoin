...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Trenchcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"trenchcointools.com", "dnsseed.trenchcointools.com"},
    {"trenchcoinpool.org", "dnsseed.trenchcoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"trenchcointools.com", "testnet-seed.trenchcointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Trenchcoin is probably already running."), addrBind.ToString().c_str());
        else
